// Binary Search Tree ADT implementation ... COMP9024 20T2
...
Tree rebalance(Tree t) {
    int numberofnodes=TreeNumNodes(t);
    if(numberofnodes >= 3){
        t=partition(t,(int)numberofnodes/2);
...
// display tree, solution by Anderson Lin (COMP9024 20T2)
...
int main(){
    ...
    newtree=TreeInsert(newtree,2);
    newtree=TreeInsert(newtree,4);
    newtree=TreeInsert(newtree,6);
    newtree=TreeInsert(newtree,8);
    newtree=TreeInsert(newtree,10);
    newtree=TreeInsert(newtree,12);
    rebalance(newtree);
    showTree(newtree);
}